...
public class Resource {
	...
	@Produces("application/json")
	public List<AggStock> getAggHoldingsByPortfolioID(@PathParam("portfolioID") int portfolioID) {
		if (bean == null) 
			return null;
		else {
			List<AggStock> p = bean.getAggHoldingsByPortfolioID(portfolioID);
			return p;
		}
	}
	
	@GET
	@Path("getStockDetails/{stockName}")
	@Produces("application/json")
	public List<Stock> getStockDetails(@PathParam("stockName") String stockName) {
